...
export const TwitterIcon = (props: IconProps) => {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class={combinedClass}>
...
export const ComputerDesktopIcon = (props: IconProps) => {
  // use heroicons computer-desktop icon
  const combinedClass = `size-24 ${props.class}`
...
export const PencilSquareIcon = (props: IconProps) => {
  // use heroicons pencil-square icon
  const combinedClass = `size-24 ${props.class}`
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class={combinedClass}>
...
export const ServerStackIcon = (props: IconProps) => {
  // use heroicons server-stack icon
  const combinedClass = `size-24 ${props.class}`
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class={combinedClass}>
...
export const Cog8ToothIcon = (props: IconProps) => {
  // use heroicons cog-8-tooth icon
  const combinedClass = `size-24 ${props.class}`
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class={combinedClass}>
...
export const PresentationChartLineIcon = (props: IconProps) => {
  // use heroicons presentation-chart-line icon
  const combinedClass = `size-24 ${props.class}`
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class={combinedClass}>
